...
StationProperties StationBuilder::constructStation(T beam_x, T chine_x, T chine_y, T keel_y)
{
...
inline double StationBuilder::sq_edge_length(int a_x, int a_y, int b_x, int b_y) {
