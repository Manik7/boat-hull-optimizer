...
struct SharedStationProperties {
	...
	StationProperties(double area, double perimeter, double flare_rad, double deadrise_rad) : 
		area(area), perimeter(perimeter), flare_rad(flare_rad), deadrise_rad(deadrise_rad) {}
		
	StationProperties(CoordType beam_x, CoordType chine_x, CoordType chine_y, CoordType keel_y) :
