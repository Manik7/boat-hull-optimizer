...
Bezier_quadratic::Bezier_quadratic(Point p1, Point p2, Point p3) : p1(p1), p2(p2), p3(p3) {};

Point_3 Bezier_quadratic::point_at_t(double t) {
	Point_3 point;
...
Point_3 Bezier_quadratic::find_point_along_z(double z_value, double epsilon = 0.001) const {
...
double Bezier_quadratic::evaluate_1D(double t, double p1_coord, double p2_coord, double p3_coord) const { 
	//TODO: assert 0 <= t <= 1
